...
void Chat::signUp()
{
	...
	std::cout << "Введите логин, состоящий из не менее восьми латинских букв и цифр и без пробелов:\n" << ">>";
	getline(std::cin, login);

	if (isValidLogin(login)) 
		std::cout << "Вaш логин прошел валидацию\n";
	else 
		std::cout << "Вaш логин не прошел валидацию\n";
}
